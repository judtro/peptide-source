...
// Get unique categories from products with videos
const categories = [...new Set(productsWithVideos.map(p => p.category))];
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <header className="mb-8 text-center sm:mb-12">
          ...
          <p className="mx-auto max-w-2xl text-sm text-muted-foreground sm:text-base lg:text-lg">
            ...
            and clinical findings for research peptides.
          </p>
        </header>
        ...
        <div className="mb-8 flex items-center justify-center gap-6 rounded-lg border border-border bg-muted/30 px-4 py-3 text-center sm:gap-12 sm:px-6 sm:py-4">
          ...
          <div>
            <p className="text-2xl font-bold text-primary sm:text-3xl">{categories.length}</p>
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-foreground">
              {selectedCategory === 'all' ? 'All Educational Videos' : selectedCategory}
            </h2>
          </div>
